...
// identify template class/function definition/declaration and
// class/function definition/declaration

// this is a template class definition:
// template <class Type> class slln { ... };

// these are template function definitions:
...
// class CBook { ... };
// in a template class definition, it is not common used for me
// class sll<Type> { ... };
...
template <class Type> ostream& operator<<(ostream&, sll<Type> const &);

// template function declaration
// it is used for friend function declaration globalPrint<Type> below
template <class Type> ostream& globalPrint(ostream&, sll<Type> const &);

// template function declaration
// it is used for a friend function declaration operator>> <Type> below
template <class Type> istream& operator>>(istream&, sll<Type>&);

// template class slln definition
template <class Type> class slln {
...
private:
	// slln() : info(0), next(NULL) { }   // original constructor
	slln() : info(Type()), next(NULL) { } // the change is typical
                                          // for a template class definition
